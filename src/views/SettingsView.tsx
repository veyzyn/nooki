...
export default function SettingsView() {
  ...
  return (
    <div className="view">
      <div className="page">
        <div className="page-inner is-narrow settings-page">
          <header className="page-intro">
            <h1 className="page-title">Settings</h1>
            <p className="page-lead">Preferences for Nooki on this computer.</p>
          </header>

          <section className="settings-row">
            <div className="settings-row-label">
              <h2 className="section-title">Relay access</h2>
              <p className="section-desc">Give one running server a public Nooki address friends can join from anywhere.</p>
            </div>
          ...
          <section className="settings-row">
            <div className="settings-row-label">
              ...
              <p className="section-desc">Where Nooki keeps new servers and backups.</p>
            </div>
            <div className="settings-row-body">
          ...
          <section className="settings-row">
            <div className="settings-row-label">
              ...
              <p className="section-desc">How Nooki behaves when the window closes and when Windows starts.</p>
            </div>
            <div className="settings-row-body">
            <div>
              <Toggle
          ...
          <section className="settings-row">
            <div className="settings-row-label">
              ...
              <p className="section-desc">Java versions Nooki can use. Servers pick a matching one automatically.</p>
            </div>
            <div className="settings-row-body">
          ...
          <section className="settings-row">
            <div className="settings-row-label">
              ...
              <p className="section-desc">Space used by servers and backups on this computer.</p>
            </div>
            <div className="settings-row-body">
